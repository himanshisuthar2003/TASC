...
<style>
    #card{
		 ...
		 header::before{ background: url('invalid.png.jpeg') no-repeat center center/cover;
            content: "";
            position: absolute;
            top: 0;
            left: 0;
...
<body>
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        <div id='card'><p>Query submitted successfully</p><form action='admin_home.php' method='get'><button type='submit' id='done'>Done</button></form></div>
        </header>";
    } else {

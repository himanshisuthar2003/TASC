...
<?php
		...
		//echo "Table criminal_record created successfully";
		} else {
...
if ($conn->query($sql) === TRUE) {
	...
	<div id='card'><p>New Record Successfully Added</p><form action='add_criminal_record(admin).php' method='get'><button type='submit' id='done'>Done</button></form></div>
	</header>";
} else {

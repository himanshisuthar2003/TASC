...
<body>
    ...
    <form action="add_criminal_record(admin)_action.php" method="get">
        <h2 class="heading">Add Criminal Records</h2>
        <label for="criminal_id">Criminal Id:</label>
        <input type="text" pattern=".{1,}" required name="criminal_id" placeholder="Enter Criminal Id..."> 
        <br>
        ...
        <input type="text" pattern=".{1,}" required name="eye_color" placeholder="Eye Color...">
        <br>

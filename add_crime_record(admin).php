...
<body>
    ...
    <form action="add_crime_record(admin)_action.php" method="get">
        <h2 class="heading">Add Crime Records</h2>
        <label for="crimerecord_id">Record Id:</label>
        <input type="text" pattern=".{1,}" required name="crimerecord_id" placeholder="Enter Record Id..."> 
        <br>
        <label for="criminal_name">Criminal Name:</label>
        <input type="text" pattern=".{1,}" required name="criminal_name" placeholder="Criminal Name...">
        <br>
        <label for="officer_name">Officer Name:</label>
        <input type="text" pattern=".{1,}" required name="officer_name" placeholder="Officer Name...">
        <br>
        <label for="case_name">Case Name:</label>
        <input type="text" pattern=".{1,}" required name="case_name" placeholder="Case Name...">
        <br>
        <label for="witness_name">Witness Name:</label>
        <input type="text" pattern=".{1,}" required name="witness_name" placeholder="Witness Name...">
        <br>
        <label for="crime_address">Crime Address:</label>
        <input type="text" pattern=".{1,}" required name="crime_address" placeholder="Crime Address...">
        <br>

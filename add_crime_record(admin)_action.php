...
<body>
	...
	$sql = "INSERT INTO crime_record (crimerecord_id, criminal_name, officer_name, case_name, witness_name,crime_address) 
		VALUES ('$crimerecord_id', '$criminal_name', '$officer_name','$case_name','$witness_name','$crime_address')";
	...
	if ($conn->query($sql) === TRUE) {
		...
		<div id='card'><p>New Record Successfully Added</p><form action='add_crime_record(admin).php' method='get'><button type='submit' id='done'>Done</button></form></div>
	</header>";
	} else {

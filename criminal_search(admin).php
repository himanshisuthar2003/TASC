...
<body>
    ...
    <form action="criminal_search_action(admin).php" method="get">
        <h2>ENTER THE CRIMINAL RECORD ID!</h2> <br>
        <label for="criminal_id">CRIMINAL RECORD ID:</label><br><input type="text" pattern=".{1,}" required name="criminal_id" placeholder="Enter here"> <br><br>

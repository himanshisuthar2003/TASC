...
<body>
    ...
    <form action="forgot_password_action.php" method="get">
        <h2>Request for your password here!</h2> <br>
        <label for="officer_id">OFFICER ID:</label><br><input type="text" pattern=".{1,}" required  name="officer_id" placeholder="Your Id.."><br><br>
        <label for="officer_name">OFFICER NAME:</label><br><input type="text" pattern=".{1,}" required  name="officer_name" placeholder="Your Name.."> <br><br>
